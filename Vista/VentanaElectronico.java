package Vista;
import javax.swing.*;
import Controlador.ControladorElectronico;
import java.awt.*;
import java.awt.event.*;
public class VentanaElectronico extends JFrame{
	...
	public VentanaElectronico(){
		...
		btnCancelar.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				controladorElectronico.cerrarLector();
			}
		});
	}	
	...
	public void addControlador(ControladorElectronico cel){
		this.controladorElectronico = cel;
	}
	...
	public JPanel _crearPTitulo(){
		...
		JLabel label = new JLabel("Registrar Producto Electronico");
	...
	public JPanel _crearPCuerpoI(){
		...
		JPanel p4 = _crearPCuerpoNumSerieNombre();
		JPanel p5 = _crearPCuerpoCorreoTelefono();
	...
	public JPanel _crearPCuerpoNumSerieNombre(){
		JPanel p = new JPanel(new GridLayout(1, 2));	
		JPanel pNumSerie = _crearPNumSerie();
...
public JPanel _crearPNumSerie(){
	...
	public JPanel _crearPCuerpoCorreoTelefono(){
		JPanel p = new JPanel(new GridLayout(1, 2));	
		JPanel pCorreo = _crearPCorreo();
		JPanel pTelefono = _crearPTelefono();
		p.add(pCorreo);
		p.add(pTelefono);
	...
	class alGuardar implements ActionListener{
		public void actionPerformed(ActionEvent e){
			...
			datos[9] = tfNumSerie.getText();
			controladorElectronico.agregarProducto(datos);
		}
	}
