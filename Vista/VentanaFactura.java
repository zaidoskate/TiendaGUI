...
public class VentanaFactura extends JFrame{
    private JTextField nombreTienda, tfcliente, nombreCliente, correoCliente, direccionCliente, rfcCliente, tfProducto, codeProducto, descripProd, provProd, precioProd, tfSubtotal, tfDescuento, tfImpuesto, tfTotal;
	...
	private JPanel datos(){
        ...
        JPanel panelProducto = new JPanel(new GridLayout(2,2));
